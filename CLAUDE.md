...
**Theme System**: `app/lib/theme-utils.ts` (semantic theme engine — `resolveTheme()` derives a full OKLCH semantic color scheme + CSS variables from 5 brand seed colors), `app/lib/theme-storage.ts`, `app/root.tsx`, `app/styles/app.css`
