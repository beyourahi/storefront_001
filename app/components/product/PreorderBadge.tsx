...
export const PreorderBadge = ({className}: PreorderBadgeProps) => {
    return (
        <Badge
            className={`bg-primary/80 hover:bg-primary/80 rounded-full px-0.5 pr-1 py-0 text-xs ${className || ""}`}
        >
            <span className="text-primary-foreground flex items-center gap-1 sm:gap-1.5 font-medium">
                <span className="bg-primary flex items-center justify-center rounded-full p-0.5 text-sm">
