...
// Configure Workbox to load modules from our self-hosted copy instead of the CDN.
// The /workbox-v7/ directory is generated by 'workbox copyLibraries' during build (prebuild hook).
// Run 'bunx workbox copyLibraries public/workbox-v7' manually for first-time dev setup.
