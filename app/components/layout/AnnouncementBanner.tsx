 ...
 *
 * @architecture
 * - Fixed container: Positioned at top: 0 with z-50
 ...
 *
 * @layout-integration
 * - useHeaderHeight hook manages --announcement-height CSS variable (auto-measured)
 * - Header uses top-[calc(...)] to position below banner
...
export function AnnouncementBanner({texts}: AnnouncementBannerProps) {
    // Measure outer container height for CSS variable
    const bannerRef = useHeaderHeight<HTMLDivElement>({
        variableName: "--announcement-height",
    ...
    return (
        ...
        // z-50 ensures it's above content but allows modals/overlays to appear above
        <div ref={bannerRef} className="fixed top-0 left-0 right-0 w-full z-50 overflow-x-clip">
