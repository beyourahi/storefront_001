...
export function CartSummary({cart}: {cart: Cart}) {
    ...
    return (
        <div className="bg-background rounded-l-2xl border-t px-4 py-4 md:px-6">
    ...
    return (
        <div>
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
                <DialogTrigger
                    className={cn(
                        "sleek border-input bg-secondary text-secondary-foreground ring-offset-background",
                        "focus-visible:ring-ring inline-flex w-full items-center justify-start gap-2",
                        "rounded-md border px-0 py-2 pl-4 text-sm font-normal",
...
function CartCheckoutActions({
    ...
    return (
        ...
        >
            ...
            {totalAmount && <Money data={totalAmount} withoutTrailingZeros />}
        </a>
    );
}
                    ...
                    <div className="mt-4 space-y-4">
                        ...
                        <div className="bg-muted/50 rounded-lg p-3">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="font-semibold">{totalAmount && <Money data={totalAmount} withoutTrailingZeros />}</span>
                            </div>
                        </div>
