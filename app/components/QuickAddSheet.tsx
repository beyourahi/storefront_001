                ...
                <SheetHeader>
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                            <SheetTitle asChild>
                                <div className="mb-0">
                                    <p className="font-sans text-xl font-medium leading-snug text-primary line-clamp-2">
                                        {titleParts[0]}
                                    </p>
                                    {titleParts[1] && (
                                        <p className="opacity-50 font-sans text-sm font-normal leading-snug">
                                            {titleParts[1]}
                                        </p>
                                    )}
                                </div>
                                    ...
                                    <div key={group.name} className="flex flex-wrap gap-2">
                                        {group.values.map(value => {
                                            ...
                                            const buttonClasses = cn(
                                                "inline-flex min-h-10 items-center justify-center gap-2 rounded-full border-2 px-3 py-1.5 text-base font-medium transition-all duration-200",
                                                "active:scale-95",
                                                isSelected
