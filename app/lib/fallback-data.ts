...
/**
 * Short brand slogan — appears in hero components, structured data, and SEO config
 * Positioned as a brief, punchy identifier separate from the full mission statement
 */
export const FALLBACK_SLOGAN = "Your store. Your story. Built to sell.";
...
export const FALLBACK_CONTACT_EMAIL = "hello@example.com";

export const FALLBACK_CONTACT_PHONE = "+1 (555) 123-4567";
...
export const FALLBACK_SECTION_HEADINGS: SectionHeadings = {
...
export const FALLBACK_FREE_SHIPPING_THRESHOLD = 7500;
...
export const FALLBACK_THEME_FONTS: ThemeFonts = {
    sans: "Inter",
    serif: "Inter",
    mono: "Inter"
};

export const FALLBACK_THEME_COLORS: ThemeCoreColors = {
...
/**
 * Default aspect ratio for collection/product cards in grid layouts
 * - "portrait"  → 2:3 (tall cards, typical for fashion)
 * - "landscape" → 3:2 (wide cards)
 * - "square"    → 1:1
 */
export const FALLBACK_THEME_CARD_ASPECT_RATIO: "portrait" | "landscape" | "square" = "portrait";

/**
 * Default aspect ratio for product images on the product detail page
 * Mirrors FALLBACK_THEME_CARD_ASPECT_RATIO but controls the PDP/carousel view
 */
export const FALLBACK_THEME_PRODUCT_IMAGE_ASPECT_RATIO: "portrait" | "landscape" | "square" = "portrait";
 ...
 * Determines whether the VideoHero / HeroSection renders a video or image background
 */
...
/**
 * Shopify collection handles for curated homepage sections
 * These are used to filter collections from general listing pages and
 * to power the featured sections on the homepage.
 * Matches the structure expected by routes/_index.tsx, MobileMenu, and search-utils.
 */
export const FALLBACK_SPECIAL_COLLECTIONS = {
    featured: "featured",
...
/**
 * Time-of-day greetings shown in VideoHero / HeroSection
 * Keyed by time window; the component selects based on current hour
 */
...
/**
 * Happy customers count displayed in the testimonials section counter
 */
export const FALLBACK_HAPPY_CUSTOMERS_COUNT = 2500;
...
<!---->`,
        ...
        collections: {nodes: [{handle: "magical-stationery", title: "Magical Stationery"}]},
        featuredImage: img("marauder-s-map-journal-img-1", `${IMG_BASE}/marauders_map_journal_magical_stationery_1.png`, "Marauder\u2019s Map Journal + Magical Stationery"),
        images: {nodes: [
            img("marauder-s-map-journal-img-1", `${IMG_BASE}/marauders_map_journal_magical_stationery_1.png`, "Marauder\u2019s Map Journal + Magical Stationery"),
            img("marauder-s-map-journal-img-2", `${IMG_BASE}/marauders_map_journal_magical_stationery_2.png`, "Marauder\u2019s Map Journal + Magical Stationery"),
            img("marauder-s-map-journal-img-3", `${IMG_BASE}/marauders_map_journal_magical_stationery_3.png`, "Marauder\u2019s Map Journal + Magical Stationery"),
            img("marauder-s-map-journal-img-4", `${IMG_BASE}/marauders_map_journal_magical_stationery_4.png`, "Marauder\u2019s Map Journal + Magical Stationery"),
        ]},
        media: {nodes: [
            {__typename: "MediaImage" as const, id: "marauder-s-map-journal-media-1", alt: "Marauder\u2019s Map Journal + Magical Stationery", image: img("marauder-s-map-journal-img-1", `${IMG_BASE}/marauders_map_journal_magical_stationery_1.png`, "Marauder\u2019s Map Journal + Magical Stationery")},
            {__typename: "MediaImage" as const, id: "marauder-s-map-journal-media-2", alt: "Marauder\u2019s Map Journal + Magical Stationery", image: img("marauder-s-map-journal-img-2", `${IMG_BASE}/marauders_map_journal_magical_stationery_2.png`, "Marauder\u2019s Map Journal + Magical Stationery")},
            {__typename: "MediaImage" as const, id: "marauder-s-map-journal-media-3", alt: "Marauder\u2019s Map Journal + Magical Stationery", image: img("marauder-s-map-journal-img-3", `${IMG_BASE}/marauders_map_journal_magical_stationery_3.png`, "Marauder\u2019s Map Journal + Magical Stationery")},
            {__typename: "MediaImage" as const, id: "marauder-s-map-journal-media-4", alt: "Marauder\u2019s Map Journal + Magical Stationery", image: img("marauder-s-map-journal-img-4", `${IMG_BASE}/marauders_map_journal_magical_stationery_4.png`, "Marauder\u2019s Map Journal + Magical Stationery")},
        ]},
        priceRange: {minVariantPrice: money("0.0"), maxVariantPrice: money("0.0")},
        compareAtPriceRange: {minVariantPrice: money("0.0")},
        variants: {nodes: [
            {
                ...
                compareAtPrice: null,
                selectedOptions: [{name: "Title", value: "Default Title"}],
                image: img("marauder-s-map-journal-img-1", `${IMG_BASE}/marauders_map_journal_magical_stationery_1.png`, "Marauder\u2019s Map Journal + Magical Stationery"),
