            ...
            <div className="mx-auto max-w-2xl px-4 py-10">
                ...
                <div className="border border-border">
                    <div className="grid grid-cols-12 border-b border-border bg-muted/30 px-3 py-1.5">
                        <span className="col-span-6 text-[10px] uppercase tracking-widest text-muted-foreground">
                            Product
                        </span>
                        <span className="col-span-2 text-center text-[10px] uppercase tracking-widest text-muted-foreground">
                            Qty
                        </span>
                        ...
                        return (
                            ...
                            >
                                <div className="col-span-6 min-w-0 pr-3">
                                    <div className="truncate text-xs font-medium">{line.merchandise.product.title}</div>
                                    {variantLabel && (
                                        <div className="truncate text-[10px] text-muted-foreground">{variantLabel}</div>
                                    )}
                                </div>
