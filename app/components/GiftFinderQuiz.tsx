...
const STEPS: QuizStep[] = [
    ...
    },
    {
        ...
        options: [
            ...
            {value: "anniversary", label: "Anniversary", sublabel: "A year worth marking", icon: <Heart className="w-7 h-7" />},
            {value: "holiday", label: "Holiday", sublabel: "Seasonal joy", icon: <Sparkles className="w-7 h-7" />},
            {value: "justbecause", label: "Just Because", sublabel: "No reason needed", icon: <Star className="w-7 h-7" />}
        ]
    },
    {
        key: "interest",
        ...
        options: [
            ...
            {value: "wellness", label: "Wellness", sublabel: "Skincare & beauty", icon: <Leaf className="w-7 h-7" />},
            ...
            {value: "outdoor", label: "Outdoor", sublabel: "Adventure & sports", icon: <Mountain className="w-7 h-7" />},
            {value: "zap", label: "Surprise Me", sublabel: "Curated picks", icon: <Zap className="w-7 h-7" />}
        ]
    }
];
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 sm:py-16">
            ...
            >
                ...
                <div
                    className={cn(
                        "grid gap-3",
                        step && step.options.length > 4 ? "grid-cols-2 sm:grid-cols-3" : "grid-cols-2"
                    )}
                >
                        ...
                        return (
                            <button
                                ...
                                style={{
                                    ...
                                    borderColor: isSelected ? "var(--brand-primary)" : "transparent",
                            ...
                            >
                                <span
                                    ...
                                    style={{
                                        background: isSelected ? "var(--brand-primary)" : "var(--surface-interactive)",
                                        color: isSelected ? "var(--brand-primary-foreground)" : "var(--text-secondary)"
                                    }}
                                >
                                    {option.icon}
                                </span>
            ...
            <div className="flex items-center justify-between mt-10 gap-3">
                ...
                <button
                    ...
                    style={{background: "var(--brand-primary)", color: "var(--brand-primary-foreground)"}}
                >
                    {currentStep === TOTAL_STEPS - 1 ? "Find my gift" : "Next"}
