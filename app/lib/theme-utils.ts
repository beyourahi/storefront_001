 ...
 * - app/styles/app.css - Default CSS variables (overridden by generated theme)
...
function deriveThemeShadowColor(colors: DerivedTheme): string {
    ...
    // Achromatic theme (black/white) — pure black matches the default in app/styles/app.css
...
export function generateThemeCssVariables(colors: DerivedTheme, fonts: ThemeFonts): string {
  ...
  /* ═══════════════════════════════════════════════════════════════════════════
     ...
     These override the defaults in app/styles/app.css
     ═══════════════════════════════════════════════════════════════════════════ */
...
export function generateTheme(coreColors: ThemeCoreColors | null, fonts: ThemeFonts | null): GeneratedTheme | null {
    ...
    // Default values - pure black/white only (matches app/styles/app.css)
